...
% Variables.FileType='Laser';%'Jelly','Chow',[]
Variables.DisplayPlot=false;
Variables.RunLaser=true;
Variables.RunFood=true;
Variables.ClusterIt=false;
Variables.DisplaySummaryPlot=false;
Variables.WindowForBehavior=5;%sec
Variables.MinimalBoatInterval=0.5;%sec
Variables.Factor=0; 
end
for AddPathAndDir=1:1%% add to pathc
% add NLX libraries
addpath('C:\Users\netas\Documents\MATLAB\Obesity\EphysNature\Field Trip Neuralynx');
addpath('C:\Users\netas\Documents\MATLAB\Obesity\EphysNature\NeuralynxMatlabImportExport_v6.0.0')
% add DLC library
addpath('C:\Users\netas\Documents\MATLAB\Obesity\EphysNature\DeepLabCut')
% add Main folder library \ bioObserve library
addpath('C:\Users\netas\Documents\MATLAB\Obesity\EphysNature')
%% find files location
if exist('E:')
...
UnitIndex=1;
for UnitNumber=1:length(Units_in_Condition)
